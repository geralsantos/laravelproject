...
//Route::group(['middleware' => ['auth','admin']], function () {
  ...
  Route::any("almacen/articulo/update/{id}",[
      'as'=>"almacen.articulo.update",
      'uses'=>"ArticuloController@update"
  ]);
  Route::any("almacen/articulo/destroy/{id}",[
      'as'=>"almacen.articulo.destroy",
